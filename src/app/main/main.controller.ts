module ts1Seed {
  ...
  export class MainCtrl {
    ...
    constructor ($scope: IMainScope) {
      ...
      If we just do this, the Thing constructor doesn't get called and we get this message:
      2322 Type '{ ... }[]' is not assignable to type 'Thing[]'.
      Property 'rank' is missing in type '{ ... }'.
      */
